...
modes_standby_fix = [SitClamMode, SitPuffedMode, PatHeadMode, ProbeHeadMode,LieMode]  # 固定待机模式
modes_standby_move = [WalkMode, WriggleMode, PullFishMode]  # 移动待机模式

# 模式映射,是所有模式的映射
modes = [SitClamMode, SitPuffedMode, PatHeadMode, ShakeHeadMode,  # 坐（摸头->摇头）
         ProbeHeadMode, LieMode,
         WalkMode,WriggleMode, PullFishMode,
